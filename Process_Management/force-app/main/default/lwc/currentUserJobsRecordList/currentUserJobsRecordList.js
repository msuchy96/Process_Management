                        ...
                        .then(jobList => {
                            ...
                            this.jobs.forEach(function (item, index) {                                
                                ...
                                if(item.Due_Date__c !== undefined && item.Due_Date__c !== null && item.Due_Date__c.length > 16) {
                                    let tempDate = new Date(item.Due_Date__c.substring(0, 4), item.Due_Date__c.substring(5, 7), item.Due_Date__c.substring(8, 10), item.Due_Date__c.substring(11, 13), item.Due_Date__c.substring(14, 16), 0, 0);
                                    item.Due_Date__c = new Date(tempDate.setMonth(tempDate.getMonth()-1));
